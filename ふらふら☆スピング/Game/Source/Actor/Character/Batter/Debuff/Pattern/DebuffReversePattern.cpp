...
void DebuffReversePattern::VerticalShake(Batter* batter)
{
	// ã‰º‚Ìk‚¦‚ðŽÀ‘•
...
void DebuffReversePattern::HorizontalShake(Batter* batter)
{
	// ¶‰E‚Ìk‚¦‚ðŽÀ‘•
	float shakeAmount = 5.0f; // k‚¦‚Ì‹­‚³
	float shakeFrequency = 10.0f; // k‚¦‚Ì•p“x
...
void DebuffReversePattern::RandomShake(Batter* batter)
{
	// ƒ‰ƒ“ƒ_ƒ€‚Èk‚¦‚ðŽÀ‘•
	float shakeAmount = 5.0f; // k‚¦‚Ì‹­‚³
	float shakeFrequency = 10.0f; // k‚¦‚Ì•p“x
