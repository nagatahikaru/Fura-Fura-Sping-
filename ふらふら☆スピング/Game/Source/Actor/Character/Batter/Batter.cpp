...
bool Batter::Start()
{
	...
	m_debuffStageManager = new DebuffStageManager();
	m_debuffStageStateMachine->SetDebuffStageManager(m_debuffStageManager->GetDebuffStageManager());
...
{	
	...
	//{
	//	m_guruGuruBatCount+=5; // 連打でカウントを増やす
