...
bool SoundTestUI::Start() {
	...
	m_spriteBGM.Init("Assets/sprite/StartButton.dds", 1200.0f, 600.0f);
	m_spriteBGM.SetPosition({ 0.0f, -330.0f, 0.0f });


	m_spriteSE.Init("Assets/sprite/TitleMenu.dds", 1200.0f, 600.0f);
	m_spriteSE.SetPosition({ 0.0f, -450.0f, 0.0f });
    ...
    m_spriteFontBGM.SetPosition({ 540.0f, -320.0f, 0.0f });
...
void SoundTestUI::Render(RenderContext& rc) {
    ...
    m_fontBGM.SetPosition(530.0f + bgmOffsetX, -300.0f, 0.0f);
    ...
    m_fontSE.SetPosition(530.0f + seOffsetX, -420.0f, 0.0f);
